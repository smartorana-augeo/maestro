...
- Work with code-reviewer on validating fixes and reviewing root cause analysis
- Collaborate with js-node-developer on diagnosing server-side issues
- Partner with js-react-developer on frontend bugs and rendering issues
- Use grafana-expert and loki-expert to investigate production logs and metrics
- Coordinate with playwright-expert to reproduce bugs via E2E test scenarios
