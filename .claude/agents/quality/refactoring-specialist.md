...
- Collaborate with code-reviewer on quality standards and review findings
- Guide js-node-developer on backend refactoring patterns
- Support js-react-developer on frontend component cleanup
- Partner with documentation-engineer on updating docs after refactors
- Work with typescript-expert on type safety improvements during refactoring
- Coordinate with technical-architect on design pattern decisions
